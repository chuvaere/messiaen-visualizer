...
M2T1 = NoteSet({0,1,3,4,6,7,9,10},
    {'r': 120, 'g': 0, 'b': 255, 'w': 0, 'i': 0},
    {'r': 120, 'g': 0, 'b': 255, 'w': 0, 'i': 0},
    name='M2T1')       # violet purple
M2T2 = NoteSet({1,2,4,5,7,8,10,11},
    {'r': 147, 'g': 108, 'b': 0, 'w': 0, 'i': 0},
    {'r': 191, 'g': 182, 'b': 0, 'w': 0, 'i': 0},
    name='M2T2')      # gold/brown
M2T3 = NoteSet({2,3,5,6,8,9,11,0},
    {'r': 0, 'g': 255, 'b': 0, 'w': 0, 'i': 0},
    {'r': 24, 'g': 200, 'b': 60, 'w': 0, 'i': 0},
    name='M2T3')        # green
M3T1 = NoteSet({0,2,3,4,6,7,8,10,11},
    {'r': 255, 'g': 175, 'b': 0, 'w': 0, 'i': 0},
    {'r': 128, 'g': 70, 'b': 0, 'w': 0, 'i': 0},
    name='M3T1')    # orange
M3T2 = NoteSet({1,3,4,5,7,8,9,11,0},
    {'r': 145, 'g': 100, 'b': 145, 'w': 0, 'i': 0},
    {'r': 128, 'g': 128, 'b': 128, 'w': 0, 'i': 0},
    name='M3T2')   # grey/mauve
M3T3 = NoteSet({2,4,5,6,8,9,10,0,1},
    {'r': 0, 'g': 0, 'b': 255, 'w': 0, 'i': 0},
    {'r': 255, 'g': 175, 'b': 0, 'w': 0, 'i': 0},
...
M6T1 = NoteSet({0,2,4,5,6,8,10,11},
    {'r': 195, 'g': 170, 'b': 0, 'w': 0, 'i': 0},
    {'r': 175, 'g': 150, 'b': 0, 'w': 0, 'i': 0},
    name='M6T1')# golden
M6T2 = NoteSet({1,3,5,6,7,9,11,0},
    {'r': 116, 'g': 45, 'b': 0, 'w': 0, 'i': 0},
    {'r': 140, 'g': 72, 'b': 0, 'w': 0, 'i': 0},
    name='M6T2')# brown, russet
M6T3 = NoteSet({2,4,6,7,8,10,0,1},
    {'r': 255, 'g': 255, 'b': 0, 'w': 0, 'i': 0},
    {'r': 128, 'g': 128, 'b': 0, 'w': 0, 'i': 0},
    name='M6T3')# yellow
M6T4 = NoteSet({3,5,7,8,9,11,1,2},
    {'r': 100, 'g': 100, 'b': 0, 'w': 0, 'i': 0},
    {'r': 50, 'g': 0, 'b': 50, 'w': 0, 'i': 0},
